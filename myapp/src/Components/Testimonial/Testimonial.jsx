      ...
      {testimonials.map((t, i) => (
        <div key={i} className="keen-slider__slide flex justify-center">
          <div className="w-full flex flex-col items-center">
            ...
            {/* Card */}
            <div className="bg-white dark:bg-black p-6 shadow-md w-full max-w-[310px] h-[320px] flex flex-col justify-between">
              {/* Message */}
...
<div className="w-full w-[500px] h-[380px] md:h-[380px] sm:h-[450px] flex flex-col items-center">
                    ...
                    <div className="bg-white dark:bg-black p-6 md:p-10 relative shadow-md flex flex-col justify-between h-[100%] w-[100%]">

...
// //   // if coming from AVAILABLE -> BOOK, selectedDate is passed in state
...
// //     (bookingFromState?.status || "").toUpperCase()
// //   );
...
// //   // --- GUEST + SHARED COUNTRY FIELDS ---
// //   const [firstName, setFirstName] = useState("");
// //   const [lastName, setLastName] = useState("");
// //   const [email, setEmail] = useState("");

// //   const [country, setCountry] = useState("Bhutan"); // SHARED
...
// //   // datepicker popovers
// //   const [openDatePickerFor, setOpenDatePickerFor] = useState(null); // 'checkin' | 'checkout' | null
...
// //       try {
// //         const res = await fetch(`${API_URL}/rooms/room-types`, {
// //           credentials: "include",
// //         });
...
// //     // If this came from AVAILABLE -> BOOK we expect a simpler `b` (row)
// //     if ((b.status || "").toUpperCase() === "AVAILABLE") {
// //       // row contains roomType, but not the detailed rooms array
// //       setSelectedRoomType(b.roomType || "");
// //       // checkIn should be taken from the passed selectedDate if available
// //       setCheckInDate(initialSelectedDate || null);
// //       setCheckOutDate(null);

// //       // prices: try to map using fetched roomTypes
// //       const room = roomTypes.find((r) => r.name === (b.roomType || ""));
// //       setRoomPrice(room ? room.price : 0);
// //       setTotalPrice(0);

// //       // clear guest/agency fields for a fresh booking
// //       setFirstName("");
// //       setLastName("");
// //       setEmail("");
// //       setPhone("");
...
// //     // REAL booking object initialization
...
// //       // If only check-in selected, show single night estimate
...
// //     ["selectedRoomType", "selectedRoomNo", "checkInDate", "checkOutDate", "roomsRequested"].forEach(
// //       (f) => validateField(f, eval(f))
// //     );
...
// //       }
// //     } else {
// //       ["firstName", "lastName", "email", "phone", "selectedRoomNo"].forEach((f) =>
...
// //       // send meals array (controlled by toggleMeal)
// //       meals,
// //       specialRequest,
...
// //       icon: "question",
// //       title: "Update Room(s)?",
// //       text: `Assign rooms: ${newRooms.join(", ")}?`,
// //       showCancelButton: true,
...
// //     try {
// //       const res = await fetch(`${API_URL}/bookings/change-room/${booking._id}`, {
// //         method: "PUT",
// //         headers: { "Content-Type": "application/json" },
// //         credentials: "include",
...
// //   // When toggling NORMAL/AGENCY, clear the opposite group of fields so nothing is retained.
// //   const handleToggleAgency = () => {
// //     setIsAgencyBooking((prev) => {
// //       const next = !prev;
// //       setErrors({});
// //       if (next) {
// //         // switched to agency: clear guest fields
// //         setFirstName("");
// //         setLastName("");
// //         setEmail("");
// //         setPhone("");
// //       } else {
// //         // switched to normal: clear agency fields
// //         setAgencyName("");
// //         setAgencyEmail("");
// //         setAgencyPhone("");
// //         setAgentName("");
...
// //               <div
// //                 ref={toggleKnobRef}
// //                 className={`absolute top-1 left-1 h-10 w-1/2 rounded-full transition-transform duration-200 ${
// //                   isAgencyBooking ? "translate-x-full" : ""
// //                 } bg-white shadow`}
// //               />
// //               <div className="absolute inset-0 flex items-center justify-between px-4 pointer-events-none">
// //                 <span className={`text-sm font-medium ${!isAgencyBooking ? "text-[#006600]" : "text-gray-500"}`}>
// //                   NORMAL
// //                 </span>
// //                 <span className={`text-sm font-medium ${isAgencyBooking ? "text-[#006600]" : "text-gray-500"}`}>
// //                   AGENCY
...
// //                   bookingStatus === "AVAILABLE" ? "bg-gray-100 cursor-not-allowed" : ""
// //                 }`}
// //               >
...
// //             {/* Check-In with calendar icon and popover */}
...
// //                 }}
// //                 className="mt-1 w-full border border-gray-300 px-3 py-3 flex items-center justify-between cursor-pointer"
// //               >
...
// //             {/* Check-Out with calendar icon and popover */}
// //             <div ref={datePickerRef} className="relative">
...
// //                     validateField("roomsRequested", e.target.value);
// //                   }}
...
// //                   className="mt-1 border border-gray-300 px-3 py-2 w-full"
// //                 />
// //               </div>
// //             </div>
...
// //                       setCountry(sel);
// //                       const found = countries.find((x) => x.name === sel);
...
// //                         <input type="checkbox" checked={meals.includes(m)} onChange={() => toggleMeal(m)} />
...
// //               <button type="submit" className="flex-1 bg-[#006600] text-white px-6 py-2 shadow hover:bg-green-800">
// //                 Confirm Booking
// //               </button>
// //             </div>
// //           </div>
...
// //           <p>
// //             <strong>Booking No:</strong> {booking.bookingNumber}
// //           </p>
// //           <p>
// //             <strong>Transaction Number:</strong> {booking.transactionNumber}
// //           </p>

// //           <p>
// //             <strong>Name:</strong> {isAgencyBooking ? agencyName || agentName : `${firstName} ${lastName}`}
// //           </p>

// //           <p>
// //             <strong>Email:</strong> {isAgencyBooking ? agencyEmail || "—" : email}
// //           </p>
...
// //           <p>
// //             <strong>Phone:</strong> {isAgencyBooking ? agencyPhone || phone : phone}
// //           </p>
...
// //             <strong>Assigned Room(s):</strong> {selectedRoomNo}
// //           </p>

// //           <p className="col-span-2">
// //             <strong>Meals:</strong> {booking.meals?.length ? booking.meals.join(", ") : "None"}
// //           </p>
...
// //           <p>
// //             <strong>Total Price:</strong> Nu. {booking.totalPrice}
// //           </p>
...
// //       {/* -------------- READ ONLY VIEW (PENDING/BOOKED/CONFIRMED) -------------- */}
...
// //                 onChange={(e) => {
// //                   setSelectedRoomNo(e.target.value);
// //                   setShowUpdateRoomBtn(true);
// //                 }}
// //                 className="border border-gray-300 px-3 py-2 rounded-lg w-60 shadow-sm"
// //               />

// //               {showUpdateRoomBtn && (
// //                 <button onClick={handleUpdateAssignedRooms} className="px-4 py-2 bg-[#009900] text-white rounded-lg shadow">
// //                   UPDATE ROOMS
// //                 </button>
// //               )}
// //             </div>
...
// //           <p>
// //             <strong>Total Price:</strong> Nu. {totalPrice}
// //           </p>
...
// //               <button className="bg-[#006600] text-white px-8 py-2 rounded-lg font-semibold hover:bg-green-800" onClick={handleCheckIn}>
// //                 Check-In
// //               </button>
// //             </div>
// //           )}
...
//   // --- fetch available room numbers when roomType + checkin + checkout change ---
//   useEffect(() => {
//     const fetchAvailableRooms = async () => {
//       // Clear previous list
//       setAvailableRooms([]);
//       setSelectedRoomNo(""); // clear current selection when parameters change
...
//           selectedRoomType
//         )}?checkIn=${encodeURIComponent(checkInStr)}&checkOut=${encodeURIComponent(checkOutStr)}`;

//         const res = await fetch(url, { credentials: "include" });
//         const data = await res.json();
//         if (res.ok && Array.isArray(data.availableRoomNumbers)) {
//             setAvailableRooms(data.availableRoomNumbers.map((r) => String(r)));
//         } else if (res.ok && Array.isArray(data.available)) {
//             setAvailableRooms(data.available.map((r) => String(r)));
//         } else {
//             setAvailableRooms([]);
//         }
...
//                     validateField("selectedRoomType", e.target.value);
//                   } else {
//                     // Keep original behavior: if AVAILABLE, we still allow internal state change
//                     setSelectedRoomType(e.target.value);
//                     validateField("selectedRoomType", e.target.value);
//                   }
//                 }}
...
//             {/* --- MOVED: Room Number dropdown (below checkin/checkout) --- */}
//             <div className="mt-4">
//               <label className="font-semibold">Room Number(s):</label>
...
//                   {/* show message when no available rooms - dropdown stays empty */}
//                   {!availableRooms.length && (
//                     <p className="text-sm mt-2 text-gray-600">No rooms available.</p>
//                   )}
//                 </>
//               )}

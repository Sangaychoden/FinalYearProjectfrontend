  ...
  const fetchStats = async () => {
    try {
      ...
      setStats({
        ...
        regional: data.regionalGuests || 0,
      });
    } catch (err) {
  ...
  return (
    <div className="space-y-8">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 px-2">
          ...
          <div className="bg-[#DAA520] text-white p-6 shadow text-center">
            <h3 className="text-lg font-sm">REGIONAL GUESTS (SAARC)</h3>
            <p className="text-3xl font-semibold mt-2">{stats.regional}</p>
          </div>
        </div>
      )}

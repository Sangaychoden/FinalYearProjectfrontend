...
const ForgotPassword = () => {
  ...
  // 🔹 Live password field validation
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        Swal.fire({
          title: "OTP Sent!",
          html: `<p style="color:#d3ffd3; font-size:16px;">An OTP has been sent to your registered admin email.</p>`,
          icon: "success",
        ...
        Swal.fire({
          title: "Error",
          text: data.message || "Email not found or unauthorized.",
          icon: "error",
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        Swal.fire({
          title: "Invalid OTP",
          text: data.message || "The OTP you entered is incorrect or expired.",
          icon: "error",
          confirmButtonColor: "#d33",
          color: "#fff",
          background: "#006600",
